...
* Sparse-SignSGD with majority voting ($`\mathsf{S}^3`$GD-MV): `python main.py --sparsity 0.1`
* SignSGD with federated voting (SignSGD-FV): `python main.py --learning_method FV`
* SignSGD with federated defense (SignSGD-FD): `python main.py --learning_method FD`
